...
# Theme basic {.tabset .tabset-fade}
...
The theme independent components include: <br>
1. Font: Arial <br>
2. Font size: subtitle 18pt (action title), title 10pt (content), axis title 12pt,<br>
axis text 12pt <br>
3. Left-Alignment of both titles <br>
